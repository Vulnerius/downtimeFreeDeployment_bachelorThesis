...
\begin{document}
	...
	Fuchs, Paul: Die Downtime-freie Bereitstellung von Microservices in Kubernetes Umgebungen. TODO:  5 Seiten, 13 Abbildungen, 1 Anlage mit Quelltexten, Hochschule Mittweida (FH), Fachbereich Angewandte Computer- und Biowissenschaften \\ \\
	Bachelorarbeit 2026
	\vfill 
	Abstract
	In the current world of software engineering developers are measured by the frequency of software releases while operations have to maintain a stable and reliable system thus creating a discrepancy in time-to-market and reliability. While DevOps has the methodology to create collaboration between these team, Site Reliability Engineering implements these principles in practice. With the introduction of an error budget team now can balance between frequent releases and reliable systems. Simply put by - Do we still have budget? Yes, then go release. No, then we maintain the reliability until we have some budget available again. This thesis analyses how the consumption of error budget can be reduced by using canary releases instead of rolling updates and further analyse the canary update with white-box monitoring.
